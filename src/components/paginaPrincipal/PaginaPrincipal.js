...
const PaginaPrincipal = (props) => {
  const tresNoticias = (categoria) => {
    ...
    for (const i in props.noticias) {
      if (
        props.noticias[i].categoria === categoria &&
        contador < 3 &&
        props.noticias[i].tituloNoticia !== "Este item es una categoria"
      ) {
        contador++;
  ...
  return (
    <>
      ...
      <CadaCategoria
        ...
        noticias={tresActualidad}
      ></CadaCategoria>
      <CadaCategoria
        categoria="deportes"
        noticias={tresDeporte}
      ></CadaCategoria>
      <CadaCategoria
        categoria="tecnologia"
        noticias={tresTecnologia}
      ></CadaCategoria>
      <CadaCategoria
        categoria="politica"
        noticias={tresPolitica}
      ></CadaCategoria>
      <CadaCategoria
        categoria="espectaculos"
        noticias={tresEspectaculos}
      ></CadaCategoria>
      <CadaCategoria
        categoria="economia"
        noticias={tresEconomia}
      ></CadaCategoria>
      <CadaCategoria categoria="salud" noticias={tresSalud}></CadaCategoria>
      <CadaCategoria
        categoria="fotografia"
        noticias={tresFotografia}
      ></CadaCategoria>
    </>
  );
};
